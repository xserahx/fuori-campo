...
<header class:navbar--transparent={transparent} class="navbar" aria-label="Main navigation">
  ...
  <div class="navbar-inner">
    <a class="logo" href="/" aria-label="Fuori campo home">
        <!-- New inline SVG logo provided by user -->
