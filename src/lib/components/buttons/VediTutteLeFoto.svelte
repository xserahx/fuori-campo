<!-- Bottone da usare nella pagina di dettaglio delle categorie (in alto a sinistra) 
 ...
 Il testo è stato cambiato in ESPLORA FOTO per renderlo pià esplicito all'utente-->

<!-- stessa configurazione di base del BackButton ma cambia icona e label-->
...
{:else}
  <button class="back-button" {type} aria-label={computedAriaLabel} {onclick}>
    {@render content()}
  </button>
{/if}
