...
<script lang="ts">
    ...
    const ICONS:  Record<Variant, string> = { 'zoom-in': 'plus',        'zoom-out': 'minus',        'close': 'x'      };
    const LABELS: Record<Variant, string> = { 'zoom-in': 'Aumenta zoom', 'zoom-out': 'Riduci zoom',  'close': 'Chiudi' };
